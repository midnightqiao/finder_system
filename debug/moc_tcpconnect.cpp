...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TcpConnect_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TcpConnect_t qt_meta_stringdata_TcpConnect = {
    {
QT_MOC_LITERAL(0, 10) // "TcpConnect"
...
const QMetaObject TcpConnect::staticMetaObject = { {
    ...
    qt_meta_stringdata_TcpConnect.offsetsAndSize,
    qt_meta_data_TcpConnect,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TcpConnect_t
, QtPrivate::TypeAndForceComplete<TcpConnect, std::true_type>
